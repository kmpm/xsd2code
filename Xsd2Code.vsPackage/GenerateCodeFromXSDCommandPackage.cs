//------------------------------------------------------------------------------
// <copyright file="GenerateCodeFromXSDCommandPackage.cs" company="Microsoft">
...
namespace Xsd2Code.vsPackage
{
    ...
    public sealed class GenerateCodeFromXSDCommandPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "c580f51c-b8e6-4dc5-b405-c7234ef48e20";

        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateCodeFromXSDCommand"/> class.
        /// </summary>
        public GenerateCodeFromXSDCommandPackage()
        {
